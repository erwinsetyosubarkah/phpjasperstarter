...
class PHPJasper
{
     ...
     */
    public function __construct($pathExecutable = null)
    {
        $this->executable = 'jasperstarter';
        $this->pathExecutable = isset($pathExecutable) ? $pathExecutable : __DIR__ . '/../bin/jasperstarter/bin';
     ...
     */
    public function process($input, $output, $options = [])
    {
     ...
     * @throws \Exception
     */
    public function listParameters($input)
    {
        if (!is_file($input)) {
            throw new Exception\InvalidInputFile();
        }
